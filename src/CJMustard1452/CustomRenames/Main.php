...
class Main extends PluginBase implements Listener{
	...
	public function onDeath(PlayerDeathEvent $event){
		if($event->getPlayer()->getLastDamageCause() instanceof EntityDamageByEntityEvent){
			if($this->getServer()->getPlayer($event->getPlayer()->getLastDamageCause()->getDamager()->getName())->getInventory()->getItemInHand()->getId() >= 1){
				$item = $this->getServer()->getPlayer($event->getPlayer()->getLastDamageCause()->getDamager()->getName())->getInventory()->getItemInHand();
				$this->getServer()->getPlayer($event->getPlayer()->getLastDamageCause()->getDamager()->getName())->getInventory()->setItemInHand($item->setLore(["§dLast Kill: " . $event->getPlayer()->getName()]));
			}
		}
	}
}
